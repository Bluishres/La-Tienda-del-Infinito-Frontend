...
/*        _images.add(File(pickedFile.path));*/
  ...
  void _subirusuario() {
    if (!_isEmailbad && !_isNickbad && !_isValidatebad) {
      _saveImage(_image, sightingRef).then((value) => _subirUsuarioBD()).catchError((Object error) {
        SuccessToast("Ha ocurrido un error al subir la imagen, por favor vuelve a subirla.");
        return error;
      });
    } else {
      setState(() {
  ...
  void _subirUsuarioBD() {
    ...
    _repo
      ...
      SuccessToast('Ocurrio un error al registrar el usuario, revise los datos.');
      return error;
    });
