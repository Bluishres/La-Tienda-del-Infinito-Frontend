...
class _ProdFavoritosPageState extends State<ProdFavoritosPage> {
  ...
  void initState() {
    super.initState();
    _user = widget.user;
    _repoTicket.getAllfavoritossByUser(id_user: _user.id).then((list) =>
        setState(() {
          _isloading = false;
          _favoritos = list;
...
Widget _createListView(BuildContext context, List<ListaUsuariosDeseado> favoritos) {
        ...
        new ListTile(
          onTap: () => Navigator.push(context, MaterialPageRoute(
              builder: (context) => DetalleProducto(
                  ...
                  getUsuarioActivo: favoritos[i].usuario))),
