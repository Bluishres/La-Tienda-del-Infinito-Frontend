...
import 'package:shopend/app/ui/pages/Producto/productosComprados.dart';
import 'package:shopend/app/ui/pages/Producto/productosFavoritos.dart';
...
class UserPerfilState extends State<UserPerfil> {
  ...
  void initState() {
    ...
    if (fechaNacimiento.text.isNotEmpty){
      fechaNacimiento.text = fechaNacimiento.text.substring(0,10);
    }
  }
        ...
        MaterialButton(
          ...
          onPressed: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => ProdCompradosPage(user: _user)));
          },
        ),
      ],
    );
        ...
        MaterialButton(
          ...
          onPressed: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => ProdFavoritosPage(user: _user)));
          },
        ),
      ],
    );
